			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='cards') }}">تقاربر الفواتير</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='invoice') }}">اضافة فاتورة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='pricing') }}">إضافة قسم</a></li>
						</ul>
					</li>
				</ul>
			</div>
